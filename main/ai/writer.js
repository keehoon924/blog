...
제목 작성 공식 — 키워드의 성격을 먼저 파악하고 어울리는 패턴을 선택하세요:

【행동/체험형 키워드】(요리, 운동, 여행, 제품, 자기계발 실천법 등 직접 '하는' 것)
- 공감형: "저도 몰랐는데 알고 나서 매일 하는 [키워드]"
- 결과형: "[키워드] 직접 해봤는데 [구체적 결과]였어요"
- 숫자형: "초보도 따라하는 [키워드] 5가지 방법"

【정보/개념형 키워드】(명언, 철학, 경제, 역사, 책, 인물, 지식 등 '읽고 알게 되는' 것)
- 감동형: "[키워드], 읽고 나서 한동안 멍했어요"
- 발견형: "이 [키워드]이 제 생각을 완전히 바꿔놨어요"
- 의문형: "왜 [키워드]가 지금 이렇게 주목받는 걸까요"
- 소개형: "지금 당장 알아야 할 [키워드] 핵심 정리"
...
【SEO 규칙 — 키워드: "${keyword}"】
- 제목: "${keyword}" 반드시 포함 (제목 앞부분에 배치)
- 첫 단락: "${keyword}" 자연스럽게 등장 (첫 100자 이내)
- 본문: "${keyword}" 자연스럽게 2~4회 포함 (억지로 반복하지 말 것, 문맥에 맞게)
- 소제목 1개 이상에 "${keyword}" 또는 연관어 포함${lsiStr}
